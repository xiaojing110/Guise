 ...
 */
@Throws(NoSuchFieldError::class)
inline fun Class<*>.findField(fieldName: String, block: Field.() -> Unit) =
    findField(fieldName).block()
 ...
 */
@Throws(NoSuchFieldError::class)
inline fun KClass<*>.findField(fieldName: String, block: Field.() -> Unit) =
    findField(fieldName).block()
...
@Throws(NoSuchMethodError::class)
fun Class<*>.findConstructorExact(vararg parameterTypes: Class<*>): Constructor<*> =
    XposedHelpers.findConstructorExact(this, *parameterTypes)


@Throws(NoSuchMethodError::class)
inline fun Class<*>.findConstructorExact(
    vararg parameterTypes: Class<*>,
    block: Constructor<*>.() -> Unit
) = findConstructorExact(*parameterTypes).block()


@Throws(NoSuchMethodError::class)
fun KClass<*>.findConstructorExact(vararg parameterTypes: KClass<*>): Constructor<*> =
    this.java.findConstructorExact(*parameterTypes.map { it.java }.toTypedArray())


@Throws(NoSuchMethodError::class)
inline fun KClass<*>.findConstructorExact(
    vararg parameterTypes: KClass<*>,
    block: Constructor<*>.() -> Unit
) = findConstructorExact(*parameterTypes).block()


fun Class<*>.findConstructorExactOrNull(vararg parameterTypes: Class<*>): Constructor<*>? =
    XposedHelpers.findConstructorExact(this, *parameterTypes)


inline fun Class<*>.findConstructorExactOrNull(
    vararg parameterTypes: Class<*>,
    block: Constructor<*>.() -> Unit
) = findConstructorExactOrNull(*parameterTypes)?.block()


fun KClass<*>.findConstructorExactOrNull(vararg parameterTypes: KClass<*>): Constructor<*>? =
    this.java.findConstructorExactOrNull(*parameterTypes.map { it.java }.toTypedArray())


inline fun KClass<*>.findConstructorExactOrNull(
    vararg parameterTypes: KClass<*>,
    block: Constructor<*>.() -> Unit
) = findConstructorExactOrNull(*parameterTypes)?.block()


fun Class<*>.findConstructorBestMatch(vararg parameterTypes: Class<*>): Constructor<*> =
    XposedHelpers.findConstructorBestMatch(this, *parameterTypes)


inline fun Class<*>.findConstructorBestMatch(
    vararg parameterTypes: Class<*>,
    block: Constructor<*>.() -> Unit
) = findConstructorBestMatch(*parameterTypes).block()


fun KClass<*>.findConstructorBestMatch(vararg parameterTypes: KClass<*>): Constructor<*> =
    this.java.findConstructorBestMatch(*parameterTypes.map { it.java }.toTypedArray())


inline fun KClass<*>.findConstructorBestMatch(
    vararg parameterTypes: KClass<*>,
    block: Constructor<*>.() -> Unit
) = findConstructorBestMatch(*parameterTypes).block()
