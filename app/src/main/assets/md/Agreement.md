...
**为使用Guise软件(以下简称‘本软件’)及服务，你应当阅读并遵守《Guise软件许可及服务协议》(以下简称‘本协议’)。请你务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款，以及开通或使用某项服务的单独协议，并选择接受或不接受。限制、免责条款可能以加粗等形式提示你注意。**

**除非你已阅读并接受本协议所有条款，否则你无权下载、安装或使用本软件及相关服务。你的下载、安装、使用、获取Guise账号、登录、使用Guise相关数据及功能等行为即视为你已阅读并同意上述协议的约束。**
...
本协议是你与Guise之间关于你下载使用、安装、使用、复制本软件，以及使用所订立的协议。
...
3.2 为了改善用户体验、完善服务内容，Guise将不断努力开发新的服务，并为你不时提供软件更新。

**3.3 开发者不承诺对Guise一直进行更新和维护。**

**3.4 本软件新版本发布后，旧版本的软件可能无法使用。Guise不保证旧版本软件继续可用及相应的客户服务，请你随时核对并下载最新版本。**



### 四、用户个人信息保护

4.1 保护用户个人信息是Guise的一项基本原则，Guise将会采取合理的措施保护用户的个人信息。未经用户许可Guise不会向第三方公开、透露用户个人信息。
...
**5.1 如果你停止使用本软件及服务或服务被终止或取消，Guise可以从服务器上永久地删除你的数据。服务停止、终止或取消后，Guise没有义务向你返还任何数据。**

**5.2 Guise不对你在本软件及服务中相关数据的删除或储存失败负责；**
