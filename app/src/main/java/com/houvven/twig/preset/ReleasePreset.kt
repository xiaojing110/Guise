...
@Suppress("unused")
internal enum class ReleasePreset(override val label: String, override val value: String) : PresetAdapter {
    ...
    ANDROID_14_0("Android 14", "14"),
    ANDROID_15_0("Android 15", "15"),
    ANDROID_16_0("Android 16", "16")
